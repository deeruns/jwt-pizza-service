...
class Metrics {
    ...
    requestTracker(req, res, next) {
        ...
        console.log(`Processing request: ${requestKey}`);
        ...
        this.methodCounters.set(method, (this.methodCounters.get(method) || 0) + 1);

        // Track pizza orders from request body
        ...
        res.on('finish', () => {
            ...
            console.log(`Request finished: ${requestKey}, Latency: ${latencyMs}ms`);
            ...
            this.sendMetricToGrafana(`http_${method.toLowerCase()}_requests_total`, this.methodCounters.get(method), 'sum', '1');
    ...
    sendMetricsPeriodically(period) {
        setInterval(() => {
            try {
                ...
                console.log('Periodic metrics:', {
                    pizzaPurchases: this.pizzaPurchases,
